...
class pessoa:
    def __init__(self, nome, password, historico, idade,cargo='Cliente'):
        self.nome = nome
...
class Chef_de_Cozinha(pessoa):
    def __init__(self, nome, password, historico, idade):
        super().__init__(nome, password,historico, idade, cargo='Chef de Cozinha')
